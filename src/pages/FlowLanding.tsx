...
import { FlowCardSection } from '../components/flow/FlowCardSection'
import { FlowMomentsRow } from '../components/flow/FlowMomentsRow'
...
const heroSlides: BillboardSlideData[] = [
  {
    ...
    children: (
      <div className="billboard-slide-actions">
        ...
        <Button variant="secondary" href="#hero-three-things">
          Explore the Journey
        </Button>
      </div>
    ),
