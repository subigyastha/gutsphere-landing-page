...
export function YouContentLibrary() {
  ...
  return (
    <section id="content" className="section-pad bg-gs-sand-light" aria-labelledby="you-content-heading">
      <div className="container-narrow">
        <p className="text-xs font-medium text-gs-coral">Free guides &amp; videos</p>
        <h2 id="you-content-heading" className="section-heading mt-3 max-w-2xl">
