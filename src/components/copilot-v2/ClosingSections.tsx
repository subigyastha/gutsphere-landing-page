...
export function HonestySection() {
  return (
    <section className="cp2-honest-band" id="honest">
      <div className="cp2-wrap cp2-honest">
        <span className="cp2-honest-badge cp2-reveal">Radical honesty</span>
        ...
        <p className="cp2-reveal cp2-honest-lead">
          ...
          health products that overpromised, you already know why that matters. Here&apos;s exactly what we
          are — and what we&apos;re not.
        </p>
        <div className="cp2-twocol">
          <div className="cp2-card-h is cp2-reveal">
            <span className="cp2-honest-ic" aria-hidden="true">
              <CheckCircle2 strokeWidth={1.5} absoluteStrokeWidth />
            </span>
            ...
            <ul>
              ...
              <li>
                A companion to your diagnosis and care team — IBS, IBD, celiac, GERD, SIBO &amp; more
              </li>
              <li>Built openly with founding members, in the honest early days</li>
            </ul>
          </div>
          <div className="cp2-card-h isnt cp2-reveal">
            <span className="cp2-honest-ic mut" aria-hidden="true">
              <CircleMinus strokeWidth={1.5} absoluteStrokeWidth />
            </span>
            <h3>What it isn&apos;t</h3>
            <ul>
