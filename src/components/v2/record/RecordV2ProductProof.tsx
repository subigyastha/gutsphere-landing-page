...
export function RecordV2ProductProof() {
  return (
    <section id="product-proof" className="section-pad bg-gs-sand" aria-labelledby="record-v2-product-heading">
      <div className="container-wide">
        <div className="max-w-3xl">
          <h2 id="record-v2-product-heading" className="section-heading mb-5">
