...
export function YouV2ValidationSection() {
  return (
    <section
      id="no-diagnosis"
      className="section-pad bg-gs-sand-light"
      aria-labelledby="you-v2-validation-heading"
    >
      <div className="container-narrow">
        <p className="text-xs font-medium text-gs-coral">
          No diagnosis required. No perfect memory required.
        </p>
        <h2 id="you-v2-validation-heading" className="section-heading mt-3 max-w-2xl">
